  ...
  fetch: function(animate) {
    $.ajax({
      ...
      success: function(dataString) {
        ...
        //console.log('first log',app.messages);
        ...
        // Only bother updating the DOM if we have a new message
          console.log('MRID ', mostRecentMessage.objectId, 'APPID', app.lastMessageId)
        if (mostRecentMessage.objectId !== app.lastMessageId) {
          console.log('HEREE render messages', mostRecentMessage.objectId);
